...
local keyboard = {}
keyboard.inline_keyboard = {{{text = '✪ Group Settings And Management ', callback_data = 'Menu:'..chat_id}},{{text= '✪ Close Directory Management' ,callback_data = 'Exit:'..chat_id}},{{text="✪ Our Team·s Channel",url="https://telegram.me/iven4"}}}
AnswerInline(Company.id,'settings','Group settings',chat_id,'✪ Welcome to The Group Manager·s List','Markdown',keyboard)
else
local keyboard = {}
keyboard.inline_keyboard = {{{text="✪ Our Team·s Channel",url="https://telegram.me/iven4"}}}			
...
local keyboard = {}
keyboard.inline_keyboard = {{
{text = '✪ Github',url="https://github.com/iven4"}
},{{text = '✪ Edited By',url="https://telegram.me/eeee2"}
},{{text = '✪ Our Team·s Channel',url="https://telegram.me/iven4"}
},{{text = '<< Bᴀᴄᴋ', callback_data = 'english'..chat_id}}}
EditInline(msg.inline_id,'`⇋ UT RAD`\n'..msg.user_first..'',keyboard)
end
...
local keyboard = {}
keyboard.inline_keyboard = {{
{text = 'بوابة المحور ❂ ',url="https://github.com/iven4"}
},{{text = 'حررت بواسطة ❂  ',url="https://telegram.me/eeee2"}
},{{text = 'فريق شانيل❂ ',url="https://telegram.me/iven4"}
